...
const Sidebar = () => {
    ...
    return (
        <div >
           ...
           <SidebarOption text='Home' Icon={<AiOutlineHome size={40}/>} />
           <SidebarOption text='Explore' Icon={<BiBell  size={40}/>} />
           <SidebarOption text='Notifications' Icon={<IoBookmarksOutline size={40}/>} />           
           <SidebarOption text='Messages' Icon={<TbNotes size={40}/>} />
           <SidebarOption text='Bookmarks' Icon={<RiPlayListAddLine size={40}/>} />
           </div>
