...
class Splash extends React.Component {
  render() {
    return (
      <>
        <header>
          <div className="g-w flex justify-b align-c">
            {/* <svg viewBox="0 0 3940 610" className="bn bo" style="height: 30px">
        ...
        <main>
          ...
          <div className="trending">
            <div className="g-w grid columns-3">
              <div>
        ...
        <footer className="footer-info">
          <div className="copyright">&copy; TOM</div>
          <div className="footer-links">
            <a target="_blank" href="https://linkedin.com/in/whatever">
              LinkedIn
            </a>
            <a target="_blank" href="https://github.com/legertom">
              GitHub
            </a>
            <a target="_blank" href="https://github.com/legertom">
              Grande Repo
